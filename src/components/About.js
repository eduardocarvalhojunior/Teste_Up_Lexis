...
const About = () => {
    const [state] = React.useState({heading: 'Quem somos?', 
    ...
    const [sections] = React.useState([
      ...
      </svg>, heading: 'Marketing Digital', text: 'Tempore corrupti temporibus fuga earum asperiores fugit laudantium.'},
    ...
    </svg>, heading: 'Desenvolvimento web', text: 'Tempore corrupti temporibus fuga earum asperiores fugit laudantium.'},
  ...
  </svg>, heading: 'Desing Grafico', text: 'Tempore corrupti temporibus fuga earum asperiores fugit laudantium.'}
    ]);
    return (
        <div className="about">
